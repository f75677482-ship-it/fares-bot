// km_commands/menu.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      const displayOwner = ownerNames[0] || config.ownerName || 'Bot المالك';
      ...
      if (fs.existsSync(imagePath)) {
        // Send image with القناة الإخبارية forwarding context
        ...
        await sock.sendMessage(extra.from, {
          ...
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              newsletterJid: config.newsletterJid || '120363161513685998@القناة الإخبارية',
