// km_commands/chatbot.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  name: 'chatbot',
  category: 'general',
  description: 'الرد الذكي التلقائي',
  ownerOnly: false,
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    ...
    return extra.reply('*أمر غير صالح.. Use .chatbot on or .chatbot off*');
  }
};
  }
};
