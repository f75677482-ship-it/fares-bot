// km_commands/random.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  ...
  execute: async (sock, msg, args, extra) => {
    try {
      ...
      if (animeData.status) {
        caption += `📊 الحالة:: ${animeData.status}\n`;
      }
      ...
      if (error.response?.status === 404) {
        await extra.reply('❌ Anime data غير موجود. Please try again.');
