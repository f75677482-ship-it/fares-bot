// km_commands/setbotpp.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!quotedMessage) {
        return extra.reply('⚠️ الرجاء الرد على to an image or sticker with the .setbotpp command!');
      }
