// km_commands/attp.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      try {
        ...
        const webpBuffer = await writeExifVid(mp4Buffer, { packname: 'Faresw_bot' });
      ...
      await extra.reply('❌ حدث خطأ while creating animated sticker!');
    }
  }
};
