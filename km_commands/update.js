// km_commands/update.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
/**
 * Update Command - Fetch latest code via ZIP (المالك Only)
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const req = client.get(url, {
        headers: {
          'User-Agent': 'Faresw_bot-Updater/1.0',
          'Accept': '*/*'
        }
      }, res => {
...
module.exports = {
  ...
  aliases: ['upgrade'],
  category: 'owner',
  description: 'Update bot from configured ZIP URL (المالك Only)',
