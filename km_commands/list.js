// km_commands/list.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
        ...
        buttons: [
          ...
          },
          {
            ...
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.github || 'https://t.me/Faresw_bot'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: 'https://whatsapp.com/القناة/0029Va90zAnIHphOuO8Msp3A'
            })
          }
        ]
      }, { quoted: msg });
