// km_commands/crop.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      if (!mediaMessage) {
        return extra.reply('✂️ الرجاء الرد على to an image/video/sticker with .crop, or send an image/video/sticker with .crop as the caption.');
      }
