// km_commands/facebook.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!text) {
        return await extra.reply('الرجاء إدخال a Facebook link for the video.');
      }
      ...
      if (!isValidUrl) {
        return await extra.reply('That is not a valid Facebook link. الرجاء إدخال a valid Facebook video link.');
      }
      ...
      await extra.reply('حدث خطأ while processing the request. Please try again later.');
    }
  }
};
  }
