// km_commands/tiktok.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
    ...
    try {
      ...
      if (!text) {
        return await sock.sendMessage(msg.key.remoteJid, { 
          text: 'الرجاء إدخال a TikTok link for the video.' 
        }, { quoted: msg });
      }
      ...
      if (!isValidUrl) {
        return await sock.sendMessage(msg.key.remoteJid, { 
          text: 'That is not a valid TikTok link. الرجاء إدخال a valid TikTok video link.' 
        }, { quoted: msg });
      }
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        text: 'حدث خطأ while processing the request. Please try again later.' 
      }, { quoted: msg });
    }
  }
};  }
