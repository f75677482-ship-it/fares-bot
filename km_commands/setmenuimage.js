// km_commands/setmenuimage.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!ctx?.quotedMessage) {
        return extra.reply('📷 الرجاء الرد على to an *image* or *sticker* to set it as the menu image.');
      }
