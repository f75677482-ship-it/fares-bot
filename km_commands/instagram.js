// km_commands/instagram.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  name: 'instagram',
  category: 'media',
  description: 'تحميل من Instagram',
  ownerOnly: false,
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!text) {
        return extra.reply('الرجاء إدخال an Instagram link for the video.');
      }
      ...
      if (!isValidUrl) {
        return extra.reply('That is not a valid Instagram link. الرجاء إدخال a valid Instagram post, reel, or video link.');
      }
      ...
      await extra.reply('❌ حدث خطأ while processing the Instagram request. Please try again.');
    }
  }
};
  }
