// km_commands/pinterest.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  name: 'pinterest',
  category: 'media',
  description: 'تحميل من Pinterest',
  ownerOnly: false,
...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!urlMatch) {
        return await extra.reply('❌ الرجاء إدخال a valid Pinterest pin URL!\n\nExamples:\n• https://in.pinterest.com/pin/1109363320773690068/\n• https://pin.it/dddddd\n• pin.it/dddddd');
      }
