// km_commands/groupstatus.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
module.exports = {
  name: 'groupstatus',
  category: 'general',
  description: 'نشر حالة في المجموعة',
  ownerOnly: false,
...
module.exports = {
  ...
  description: 'Post replied media or text as a WhatsApp group status (new Group الحالة: feature).',
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      // Only inside groups
      if (!extra.isGroup) {
        return extra.reply('👥 هذا الأمر للمجموعات فقط!.');
      }
