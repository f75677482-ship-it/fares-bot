// km_commands/autostatus.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
 ...
 * المالك only. When someone posts a status, bot views it and optionally reacts.
 */
      ...
      if (sub === 'readreceipts') {
        if (val === 'on') {
          try {
            ...
            return extra.reply('✅ Bot read receipts enabled. الحالة: poster will now see when bot views their status.');
          } catch (e) {
