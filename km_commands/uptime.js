// km_commands/uptime.js — مدمج من KnightBot-Mini، مُعَرَب + حقوق موحدة
...
const botVersion = 'V1.0.3';
    ...
    message += `🧬 *Bot Version:* ${botVersion}\n`;
      ...
      await extra.reply('❌ حدث خطأ while fetching uptime information. Please try again later.');
    }
  }
};
